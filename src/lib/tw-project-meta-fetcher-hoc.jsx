...
const API_URL = 'https://localhost:8080/api/v1/projects/getproject?projectID=$id&requestType=metadata';
const API_REMIX_URL = 'https://localhost:8080/api/v1/projects/getremixes?projectId=$id';
